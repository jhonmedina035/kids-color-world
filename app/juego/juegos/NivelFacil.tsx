...
const IMAGES_BY_COLOR = {
  azul: [
    {
      id: "pez_azul",
      src: require(`${IMAGE_BASE_PATH}pez_azul-removebg-preview.png`),
      color: "azul",
    },
    {
      id: "mariposa_azul",
      src: require(`${IMAGE_BASE_PATH}mariposa_azul-removebg-preview.png`),
      color: "azul",
    },
    {
      id: "fresa_roja",
      src: require(`${IMAGE_BASE_PATH}Fresa_roja-removebg-preview.png`),
      color: "rojo",
    },
    {
      id: "manzana_verde",
      src: require(`${IMAGE_BASE_PATH}manzana_verde-removebg-preview.png`),
      color: "verde",
    },
  ],
  amarillo: [
    {
      id: "pato_amarillo",
      src: require(`${IMAGE_BASE_PATH}Pato_amarillo-removebg-preview.png`),
      color: "amarillo",
    },
    {
      id: "platano_amarillo",
      src: require(`${IMAGE_BASE_PATH}platano_amarillo-removebg-preview.png`),
      color: "amarillo",
    },
    {
      id: "cereza_roja",
      src: require(`${IMAGE_BASE_PATH}cereza_roja-removebg-preview.png`),
      color: "rojo",
    },
    {
      id: "hoja_verde",
      src: require(`${IMAGE_BASE_PATH}hoja_verde-removebg-preview.png`),
      color: "verde",
    },
  ],
  verde: [
    {
      id: "bicicleta_verde",
      src: require(`${IMAGE_BASE_PATH}bicicleta_verde-removebg-preview.png`),
      color: "verde",
    },
    {
      id: "manzana_verde_2",
    ...
    {
      id: "abeja_amarilla",
      src: require(`${IMAGE_BASE_PATH}abeja_amarilla-removebg-preview.png`),
      color: "amarillo",
    },
    {
      id: "mochila_roja",
      src: require(`${IMAGE_BASE_PATH}mochila_roja-removebg-preview.png`),
      color: "rojo",
    },
  ],
  rojo: [
  ...
  naranja: [
    {
      id: "naranja_fruta",
      src: require(`${IMAGE_BASE_PATH}naranja-removebg-preview.png`),
      color: "naranja",
    },
    {
      id: "zanahoria",
      src: require(`${IMAGE_BASE_PATH}zanahoria-removebg-preview.png`),
      color: "naranja",
    },
    {
      id: "uva",
      src: require(`${IMAGE_BASE_PATH}uva-removebg-preview.png`),
      color: "morado",
    },
    {
      id: "limon",
      src: require(`${IMAGE_BASE_PATH}limon-removebg-preview.png`),
      color: "amarillo",
    },
  ],
  morado: [
    ...
    {
      id: "berenjena",
      src: require(`${IMAGE_BASE_PATH}berenjena-removebg-preview.png`),
      color: "morado",
    },
    {
      id: "cereza",
  ...
  rosa: [
    {
      id: "flor_rosa",
      src: require(`${IMAGE_BASE_PATH}flor_rosa-removebg-preview.png`),
      color: "rosa",
    },
    {
      id: "cerdito",
      src: require(`${IMAGE_BASE_PATH}cerdito-removebg-preview.png`),
      color: "rosa",
    },
    {
      id: "azul_pez",
  ...
  negro: [
    {
      id: "gato_negro",
      src: require(`${IMAGE_BASE_PATH}gato_negro-removebg-preview.png`),
      color: "negro",
    },
    {
      id: "neumatico_negro",
      src: require(`${IMAGE_BASE_PATH}neumatico_negro-removebg-preview.png`),
      color: "negro",
    },
    {
      id: "amarillo_pato",
...
const ColorGameCard: React.FC<ColorGameCardProps> = React.memo(
  ({
    data,
    onCorrectAnswer,
    isSpeaking,
    ...
    const getQuestionTextColor = (colorName: string) => {
      switch (colorName) {
        case "amarillo":
          return "#000"; // Negro para amarillo
        case "negro":
          return "#fff"; // Blanco para negro
        default:
          return "#000"; // Predeterminado negro
      }
    };
    ...
    const speak = useCallback(
      async (text: string, options?: Speech.SpeechOptions) => {
        ...
        speakingTimeoutRef.current = setTimeout(() => {
          console.warn(
            "TTS Fallback: Forzando isSpeaking a false después de 5s. La interfaz será desbloqueada."
          );
          finishSpeaking();
        }, 5000);
    ...
    const handleImagePress = useCallback(
      async (imageColor: string, imageId: string) => {
        ...
        if (imageColor === data.targetColor) {
          ...
          await speak(
            `Este no es. Inténtalo de nuevo. Buscamos el color ${data.targetColor}.`,
            { pitch: 0.9 }
          );
          setTimeout(() => {
          ...
          {questionParts.map((part, index) => (
            <React.Fragment key={index}>
              <Text
                style={[
                  styles.questionText,
                  { color: getQuestionTextColor(data.targetColor) },
                ]}
              >
                {part}
              </Text>
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                answeredCorrectly &&
                  ...
                  styles.correctImageButton,
                answeredCorrectly &&
                  image.color !== data.targetColor &&
                  selectedImageId === image.id &&
                  styles.incorrectImageButton,
              ]}
...
ColorGameCard.displayName = "ColorCard";
...
const NivelFacil = () => {
  ...
  const handleCorrectAnswer = useCallback(() => {
    if (currentIndex < GAME_LEVELS.length - 1) {
      ...
      Alert.alert(
        "¡Felicidades!",
        "Has completado todos los niveles de colores.",
        [{ text: "Volver al menú", onPress: () => router.back() }]
      );
      Speech.speak(
        "¡Felicidades! Has completado todos los niveles de colores.",
        { language: "es" }
      );
    }
  }, [currentIndex, router]);
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <FlatList
        ...
        data={GAME_LEVELS}
        renderItem={(
          { item, index } // <- Añadimos 'index' aquí
        ) => (
          <ColorGameCard
            data={item}
